...
export default function SociaLiftPage() {
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <div className="columns-2 sm:columns-2 md:columns-3 lg:columns-3 gap-4">
        {[
        project.image6,
        project.image7,
        project.image8,
        ...
        <div
          key={idx}
          className="overflow-hidden rounded mb-4 cursor-pointer"
          onClick={() => { if (src) setSelectedImage(src); }}
        >
          <img
          src={src}
          alt={`${project.title} image ${idx + 6}`}
          className="w-full h-auto object-contain"
          />
        </div>
        ))}
