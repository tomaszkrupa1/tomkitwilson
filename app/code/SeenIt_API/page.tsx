...
export default function SeenItAPIPage() {
    const project = projects.find((proj) => proj.id === 'SeenIt_API');
    if (!project) {
      ...
      <div className="space-y-6">
        ...
        */}
        ...
        <div className="w-full flex flex-col gap-1">
          ...
          <p className="text-gray-700">{project.info5}</p>
        </div>
        <div className="w-full flex flex-col gap-1">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-black">
          GET /api/articles/:article_id/comments
          </h2>
          <p className="text-gray-700">{project.info6}</p>
        </div>
        <div className="w-full flex flex-col gap-1">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-black">
          GET /api/users
          </h2>
          <p className="text-gray-700">{project.info7}</p>
        </div>
        <div className="w-full flex flex-col gap-1">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-black">
          POST /api/articles/:article_id/comments
          </h2>
          <p className="text-gray-700">{project.info8}</p>
        </div>
        <div className="w-full flex flex-col gap-1">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-black">
          PATCH /api/articles/:article_id
          </h2>
          <p className="text-gray-700">{project.info9}</p>
        </div>
        <div className="w-full flex flex-col gap-1">
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-black">
          DELETE /api/comments/:comment_id
          </h2>
          <p className="text-gray-700">{project.info10}</p>
        </div>
        </div>
      </div>
      </div>
